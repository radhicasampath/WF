public class MaximumNumOfBalloons {
    ...
    public static void main(String[] args) {
        System.out.println(new MaximumNumOfBalloons().maxNumberOfBalloons("nlaebolko"));
        System.out.println(new MaximumNumOfBalloons().maxNumberOfBalloons("loonbalxballpoon"));
    }
}
